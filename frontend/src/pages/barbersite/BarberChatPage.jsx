      ...
      <div key={message.id}>
        ...
        <div className={`flex ${isCurrentUser ? 'justify-end' : 'justify-start'}`}>
          <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg transition-opacity ${
            isCurrentUser 
              ? `bg-green-600 text-white ${isTemporary ? 'opacity-70' : ''}` 
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              {isTemporary && (
                <div className="text-xs text-green-200 ml-2">Sending...</div>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-start">
        <div className="bg-white text-gray-800 border px-4 py-2 rounded-lg max-w-xs">
          ...
          <p className="text-xs text-gray-500 mt-1">
            {bookingInfo?.other_user.name || customerName} is typing...
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex flex-col flex-1 bg-white rounded-lg shadow-lg m-4 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-4">
              <button
                ...
                className="flex items-center text-white hover:text-green-200 mb-2 transition-colors"
              >
